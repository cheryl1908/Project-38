...
function setup() {
  ...
  //invisibleBG=createSprite(450,150,900,300);
...
function draw() {
  ...
  spawnObstacles();
     ...
     if(cakesGroup.isTouching(trex)){
       trex.lifetime=1000000000000000000;
     }
   }
...
function spawnCakes() {
    var cake = createSprite(camera.x+width/2,120,40,10);
    cake.y = Math.round(random(80,120));
